...
func TestTemplatesEmbedded(t *testing.T) {
	wantPaths := map[Kind][]string{
		TestNG:     {"templates/testng/src/test/java/__PKG__/SuluLabelListener.java.tmpl", "templates/testng/src/test/resources/META-INF/services/org.testng.ITestNGListener.tmpl"},
